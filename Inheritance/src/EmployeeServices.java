...
public class EmployeeServices {
	...
	static {
		...
		emparr[0]=new SalariedEmployee(12,"Rajat","4444","a@gmail.com","hr","associate",LocalDate.of(2002, 12,30),4556,345);
		emparr[1]=new SalariedEmployee(13,"Ajit","555","a22@gmail.com","admin","associate",LocalDate.of(2002, 10,30),4577,377);
	...
	public static void addNewEmployee(int ch) {
		...
		case 1:
			...
			emparr[cnt]=new SalariedEmployee(pid, nm, mob, em, dept, desg,ldt, s, b);
		case 2:
		...
		public static boolean ModifySalById(int pid, double s) {
			...
			if(pos!=-1) {
				if(emparr[pos] instanceof SalariedEmployee) {
					((SalariedEmployee)emparr[pos]).setSal(s);
